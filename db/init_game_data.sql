...
CREATE TABLE item_document_page(
	...
	content_alignment VARCHAR(6) NOT NULL DEFAULT "left",
...
CREATE TABLE item_equipment_particle(
    ...
    is_climb_hidden BOOLEAN NOT NULL DEFAULT FALSE,
