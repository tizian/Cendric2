...
INSERT INTO text (text_id, english, german, swiss_german, spanish) values ('CannotEquipInLevel','You cannot equip items inside a level!','Gegenstände können nicht in einem Level ausgerüstet werden!','Gegeständ chönd nid imne Level agleit werde!','¡No puede equipar objetos dentro del nivel!');
INSERT INTO text (text_id, english, german, swiss_german, spanish) values ('CannotConsumePermanentInLevel','You cannot consume permanent items inside a level!','Gegenstände mit permanenten Boni können nicht in einem Level verwendet werden!','Gegeständ mit permanente Boni chönd nid imne Level verbruucht werde!','¡No puedes usar objetos permanentes dentro del nivel!');
