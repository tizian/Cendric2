...
INSERT INTO text (text_id, english, german, swiss_german, spanish) values ('LockpickLevel','Picklock Level','Dietrich Stufe','Dietrich Level','Nivel de ganzúa');
...
INSERT INTO text (text_id, english, german, swiss_german, spanish) values ('SpellAntiGravityDesc','Reverses your gravity.','Dreht deine Schwerkraft um.','Drüllt dini Schwerchraft um.','Invierte la gravedad de Cendric.');
...
INSERT INTO text (text_id, english, german, swiss_german, spanish) values ('SpellAureolaDesc','Sends balls of light in all directions, if they hit an enemy they will return to you and heal you.','Schickt Lichtbälle in alle Richtungen, die zurückkehren und dich heilen, falls sie einen Gegner treffen.','Schickt Liechtbäll in all Richtige, wo zruggchömed und dich heiled wenn si en Gegner troffe hend.','Arroja esferas de luz en todas direcciones. Si golpean a un enemigo, regresan a Cendric y lo curan.');
...
INSERT INTO text (text_id, english, german, swiss_german, spanish) values ('SpellDivineShieldDesc','Grants a shield that enhances your resistances and heals you once.','Umhüllt dich mit einem Schild, der dich einmalig heilt und für eine gewisse Dauer deine Resistenzen erhöht.','Umhüllt dich mitme Schild wo dich eimalig heilt und dini Resistenze für e gwüssi Ziit erhöht.','Otorga un escudo que aumenta la resistencias de Cendric y lo cura una vez.');
...
INSERT INTO text (text_id, english, german, swiss_german, spanish) values ('SpellFlashDesc','Lets you dash forward with the speed of light, ignores most blocks and damages enemies.','Lässt dich mit Lichtgeschwindigkeit vorwärts schiessen, ignoriert die meisten Blöcke und schadet Gegner.','Laht dich mit Liechtgschwindigkeit vorwärts schüsse, ignoriert di meiste Blöck und schadet Gegner.','Cendric avanza a la velocidad de la luz, sobrepasa la mayoría de bloqueos y daña a los enemigos.');
...
INSERT INTO text (text_id, english, german, swiss_german, spanish) values ('SpellLeapOfFaithDesc','A holy power flows through you, enabling you to jump higher and fall slower for a certain duration.','Eine heilige Kraft durchströmt dich, die dich höher springen und langsamer fallen lässt.','E heiligi Kraft durchströmt dich, mit dere du höcher springe und langsamer falle chasch.','Un poder divino fluye a través de Cendric, el cual le premite saltar más alto y caer más despacio por cierto tiempo.');
...
INSERT INTO text (text_id, english, german, swiss_german, spanish) values ('SpellHolyFireDesc','Summons a holy fire that burns enemies in range.','Beschwört ein heiliges Feuer, das Gegner in der Nähe verbrennt.','Beschwört es heiligs Füür wo Gegner ide Nöchi verbrennt.','Cendric convoca a un fuego divino que quema a enemigos al alcance.');
...
INSERT INTO text (text_id, english, german, swiss_german, spanish) values ('SpellSummonGargoyleDesc','Summons a mighty gargoyle that serves you and attacks enemies.','Beschwört einen mächtigen Gargoyle, der Gegner attackiert.','Beschwört en mächtige Gargoyle wo Gegner aagrift.','Cendric convoca una poderosa gárgola a su servicio y ataca enemigos.');
...
INSERT INTO text (text_id, english, german, swiss_german, spanish) values ('SpellGhostFormDesc','You take the shape of a ghost, which enables you to walk through certain blocks, walk faster and gain additional armour.','Du nimmst eine Geisterform an, was dich durch bestimmte Blöcke gehen lässt, dich schneller macht und dir zusätzliche Rüstung gewährt.','Du nimmsch e Geisterform ah, mit dere du dur gwüssi Blöck laufe chasch, schneller laufsch und me Rüschtig hesch.','Cendric adopta la forma de fantasma, lo que le permite caminar más rápido, atravesar ciertos obstáculos y ganar armadura adicional.');
...
INSERT INTO text (text_id, english, german, swiss_german, spanish) values ('SpellInvisibilityDesc','Renders you invisible for a certain duration for certain enemies','Du wirst unsichtbar für eine gewisse Zeit und für gewisse Gegner.','Du wirsch unsichtbar für e gwüssi Ziit und gwüssi Gegner.','Hace invisible a Cendric ante algunos enemigos por cierto tiempo.');
