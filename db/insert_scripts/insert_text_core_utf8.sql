...
INSERT INTO text (text_id, english, german, swiss_german, spanish) values ('SpellAntiGravityDesc','Reverses gravity for Cendric.','Dreht Cendrics Schwerkraft um.','Drüllt em Cendric sini Schwerchraft um.','Invierte la gravedad de Cendric.');
