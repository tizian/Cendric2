...
INSERT INTO text (text_id, text_type, english, german, swiss_german, spanish) values ('Waypoint', 'hint_desc','After you''ve activated a waypoint, you can always teleport back.','Nachdem du einen Wegpunkt aktiviert hast, kannst du dich immer dorthin zurück teleportieren.','Wenn du en Wägpunkt aktiviert hesch, chasch dich immer det ane zrugg teleportiere.','Después de activar las coordenadas, puedes teletransportarte de regreso siempre.');
