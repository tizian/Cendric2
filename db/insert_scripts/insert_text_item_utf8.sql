...
INSERT INTO text (text_id, text_type, english, german, swiss_german) values ('we_rustysword', 'item_desc', 'Doesn''t seem to have been used lately.','Wurde wohl schon länger nicht mehr benutzt.','Isch glaub scho länger nüm brucht worde.');
