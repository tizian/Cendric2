-- Hunter Edmond
INSERT INTO text (text_id, text_type, english, german, swiss_german) values ('DestroyBlocks', 'speech','Destroy these rocks with your weapon so we can move on!','Zerstöre diese Felsen mit deiner Waffe, dass wir weitergehen können!','Zestör die Felse mit dinere Waffe so dasmer wiiter chömed!');
