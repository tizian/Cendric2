...
INSERT INTO item_attribute (item_id, dmg_ice, max_health, res_physical, res_ice) values ('eq_wizardhatice', 4, 5, 10, 20);
...
INSERT INTO item_attribute (item_id, res_fire, max_health, res_physical, dmg_fire) values ('eq_wizardhatfire', 20, 5, 10, 4);
...
INSERT INTO item_attribute (item_id, dmg_light, res_light, max_health, res_physical) values ('eq_wizardhatlight', 4, 20, 5, 10);
...
INSERT INTO item_attribute (item_id, res_shadow, max_health, res_physical, dmg_shadow) values ('eq_wizardhatshadow', 20, 5, 10, 4);
...
INSERT INTO item_attribute (item_id, res_fire, max_health, res_light, dmg_shadow) values ('eq_oversizedhat', 3, 5, 10, 5);
...
INSERT INTO item_attribute (item_id, res_fire, max_health, res_physical, dmg_shadow) values ('eq_mercenarybandana', 2, 7, 2, 1);
...
INSERT INTO item_attribute (item_id, max_health, res_physical, res_ice) values ('eq_wolfbonnet', 5, 10, 20);
...
INSERT INTO item_attribute (item_id, dmg_shadow, res_light, dmg_fire, dmg_physical, res_physical, critical, haste, max_health) values ('eq_nekomataback', 2, 40, 2, 1, 7, 4, 10, 20);
...
INSERT INTO item_attribute (item_id, dmg_shadow, res_light, dmg_fire, dmg_physical, res_physical, critical, haste, max_health) values ('eq_nekomatahead', 3, 40, 3, 2, 10, 7, 10, 40);
...
INSERT INTO item_attribute (item_id, dmg_shadow, res_light, res_shadow, res_physical, critical, haste, dmg_ice, max_health) values ('eq_back_necrot1', 1, 10, 10, 10, 1, 2, 1, 5);
...
INSERT INTO item_attribute (item_id, dmg_shadow, res_light, res_shadow, res_physical, critical, haste, dmg_ice, max_health) values ('eq_back_necrot2', 2, 20, 20, 40, 2, 4, 2, 10);
...
INSERT INTO item_attribute (item_id, dmg_shadow, res_light, res_shadow, res_physical, critical, haste, dmg_ice, max_health) values ('eq_back_necrot3', 4, 40, 40, 50, 4, 8, 4, 20);
...
INSERT INTO item_attribute (item_id, dmg_shadow, res_light, res_shadow, res_physical, critical, haste, dmg_ice, max_health) values ('eq_body_necrot1', 4, 5, 5, 10, 2, 2, 4, 15);
...
INSERT INTO item_attribute (item_id, dmg_shadow, res_light, res_shadow, res_physical, critical, haste, dmg_ice, max_health) values ('eq_body_necrot2', 8, 10, 10, 20, 4, 4, 8, 30);
...
INSERT INTO item_attribute (item_id, dmg_shadow, res_light, res_shadow, res_physical, critical, haste, dmg_ice, max_health) values ('eq_body_necrot3', 15, 20, 20, 40, 8, 8, 15, 60);
...
INSERT INTO item_attribute (item_id, dmg_shadow, res_light, res_shadow, res_physical, critical, haste, dmg_ice, max_health) values ('eq_head_necrot1', 4, 4, 4, 5, 1, 4, 4, 6);
...
INSERT INTO item_attribute (item_id, dmg_shadow, res_light, res_shadow, res_physical, critical, haste, dmg_ice, max_health) values ('eq_head_necrot2', 8, 8, 8, 10, 2, 8, 8, 12);
...
INSERT INTO item_attribute (item_id, dmg_shadow, res_light, res_shadow, res_physical, critical, haste, dmg_ice, max_health) values ('eq_head_necrot3', 15, 15, 15, 20, 4, 15, 15, 24);
...
INSERT INTO item_attribute (item_id, res_light, dmg_fire, dmg_light, res_physical, critical, haste, max_health) values ('eq_back_divinet1', 3, 3, 4, 2, 1, 3, 4);
...
INSERT INTO item_attribute (item_id, res_light, dmg_fire, dmg_light, res_physical, critical, haste, max_health) values ('eq_back_divinet2', 6, 6, 8, 3, 2, 6, 8);
...
INSERT INTO item_attribute (item_id, res_light, dmg_fire, dmg_light, res_physical, critical, haste, max_health) values ('eq_back_divinet3', 12, 12, 16, 6, 4, 12, 15);
...
INSERT INTO item_attribute (item_id, res_light, dmg_fire, dmg_light, res_physical, critical, haste, max_health) values ('eq_head_divinet1', 5, 4, 4, 3, 1, 4, 5);
...
INSERT INTO item_attribute (item_id, res_light, dmg_fire, dmg_light, res_physical, critical, haste, max_health) values ('eq_head_divinet2', 10, 8, 8, 6, 2, 8, 10);
...
INSERT INTO item_attribute (item_id, res_light, dmg_fire, dmg_light, res_physical, critical, haste, max_health) values ('eq_head_divinet3', 20, 15, 15, 12, 4, 16, 20);
...
INSERT INTO item_attribute (item_id, res_light, dmg_fire, dmg_light, res_physical, critical, haste, max_health) values ('eq_body_divinet1', 10, 4, 4, 10, 2, 2, 10);
...
INSERT INTO item_attribute (item_id, res_light, dmg_fire, dmg_light, res_physical, critical, haste, max_health) values ('eq_body_divinet2', 15, 8, 8, 20, 4, 4, 20);
...
INSERT INTO item_attribute (item_id, res_light, dmg_fire, dmg_light, res_physical, critical, haste, max_health) values ('eq_body_divinet3', 30, 16, 20, 50, 6, 8, 50);
...
INSERT INTO item_attribute (item_id, dmg_shadow, dmg_physical, res_shadow, res_physical, critical, haste, max_health) values ('eq_head_twilightt1', 5, 3, 5, 2, 2, 5, 4);
...
INSERT INTO item_attribute (item_id, dmg_shadow, dmg_physical, res_shadow, res_physical, critical, haste, max_health) values ('eq_head_twilightt2', 10, 6, 10, 5, 4, 8, 8);
...
INSERT INTO item_attribute (item_id, dmg_shadow, dmg_physical, res_shadow, res_physical, critical, haste, max_health) values ('eq_head_twilightt3', 20, 12, 20, 15, 8, 10, 16);
...
INSERT INTO item_attribute (item_id, dmg_shadow, dmg_physical, res_shadow, res_physical, critical, haste, max_health) values ('eq_back_twilightt1', 4, 3, 3, 2, 2, 2, 4);
...
INSERT INTO item_attribute (item_id, dmg_shadow, dmg_physical, res_shadow, res_physical, critical, haste, max_health) values ('eq_back_twilightt2', 6, 8, 6, 3, 4, 6, 8);
...
INSERT INTO item_attribute (item_id, dmg_shadow, dmg_physical, res_shadow, res_physical, critical, haste, max_health) values ('eq_back_twilightt3', 12, 16, 12, 6, 8, 12, 16);
...
INSERT INTO item_attribute (item_id, dmg_shadow, dmg_physical, res_shadow, res_physical, critical, haste, max_health) values ('eq_body_twilightt1', 5, 3, 10, 10, 2, 5, 10);
...
INSERT INTO item_attribute (item_id, dmg_shadow, dmg_physical, res_shadow, res_physical, critical, haste, max_health) values ('eq_body_twilightt2', 8, 6, 15, 20, 5, 8, 20);
...
INSERT INTO item_attribute (item_id, dmg_shadow, dmg_physical, res_shadow, res_physical, critical, haste, max_health) values ('eq_body_twilightt3', 15, 10, 30, 50, 10, 15, 40);
...
INSERT INTO item_attribute (item_id, res_ice, max_health, res_physical, res_fire) values ('eq_leatherarmor', 3, 10, 5, 3);
...
INSERT INTO item_attribute (item_id, haste, critical, res_light, res_fire, res_physical) values ('eq_rafishat', -20, 10, 3, 2, 1);
...
INSERT INTO item_attribute (item_id, dmg_physical, critical, haste, res_light, res_physical) values ('eq_huntershat', 5, 2, 2, 10, 3);
...
INSERT INTO item_attribute (item_id, critical, dmg_fire) values ('eq_rubyring', 2, 5);
...
INSERT INTO item_attribute (item_id, dmg_physical, max_health) values ('eq_ironring', 2, 6);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_light, critical, haste) values ('eq_sunring', 5, 3, 3, 10);
...
INSERT INTO item_attribute (item_id, critical, res_fire) values ('eq_silvernecklace', 1, 5);
...
INSERT INTO item_attribute (item_id, critical, dmg_fire) values ('eq_rubynecklace', 1, 7);
...
INSERT INTO item_attribute (item_id, dmg_physical, critical, haste, res_physical) values ('eq_swordpendant', 7, 2, 5, -10);
...
INSERT INTO item_attribute (item_id, max_health, health_regeneration) values ('eq_lifependant', 5, 1);
