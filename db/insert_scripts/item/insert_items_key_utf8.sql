...
INSERT INTO item (item_id, item_type, icon_left, icon_top, gold_value) values ('ke_tower', 'key', 100, 450, -1);
...
INSERT INTO text (text_id, text_type, english, german, swiss_german) values ('ke_tower', 'item_desc', 'The key to the tower in Gandria.','Der Schlüssel für den Turm in Gandria.','De Schlüssel für de Turm in Gandria.');
