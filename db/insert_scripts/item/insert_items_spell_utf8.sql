...
INSERT INTO text (text_id, text_type, english, german, swiss_german, spanish) values ('sp_leech', 'item_desc','Sends out leeching spells that damage enemies and return to you to heal you if they hit an enemy.','Schickt lebensraubende Zauber aus, die zu dir zurückkehren, um dich zu heilen, falls sie einen Gegner getroffen haben.','Schickt lebensraubendi Zauber uus wo zu dir zruggchömed zum dich heile falls si en Gegner troffe hend.','Envía un hechizo de sanguijuelas que dañan a los enemigos y regresan a Cendric para curarlo cuando golpean a un enemigo.');
...
INSERT INTO text (text_id, text_type, english, german, swiss_german, spanish) values ('sp_antigravity', 'item_desc','Reverses your gravity.','Dreht deine Schwerkraft um.','Drüllt dini Schwerchraft um.','Invierte la gravedad.');
...
INSERT INTO text (text_id, text_type, english, german, swiss_german, spanish) values ('sp_summongargoyle', 'item_desc','Summons a mighty gargoyle that serves you and attacks enemies.','Beschwört einen mächtigen Gargoyle, der Gegner attackiert.','Beschwört en mächtige Gargoyle wo Gegner aagrift.','Cendric convoca una poderosa gárgola a su servicio y ataca enemigos.');
...
INSERT INTO text (text_id, text_type, english, german, swiss_german, spanish) values ('sp_aureola', 'item_desc','Sends balls of light in all directions, if they hit an enemy they will return to you and heal you.','Schickt Lichtbälle in alle Richtungen, die zurückkehren und dich heilen, falls sie einen Gegner treffen.','Schickt Liechtbäll in all Richtige, wo zruggchömed und dich heiled wenn si en Gegner troffe hend.','Arroja esferas de luz en todas direcciones. Si golpean a un enemigo, regresan a Cendric y lo curan.');
