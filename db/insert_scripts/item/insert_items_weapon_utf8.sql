...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_ice, max_health) values ('we_icestaff', 5, 10, 10);
...
INSERT INTO item_attribute (item_id, dmg_physical, max_health, dmg_fire) values ('we_firestaff', 5, 10, 8);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_ice, max_health) values ('we_tearstaff', 5, 10, 20);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_light, dmg_ice, critical, max_health) values ('we_pearlsabre', 2, 4, 3, 2, 5);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_light, critical, max_health) values ('we_lightningpike', 4, 8, 4, 8);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_ice, max_health, dmg_fire) values ('we_sicklestaff', 5, 10, 10, 10);
...
INSERT INTO item_attribute (item_id, critical, max_health) values ('we_enchanteddagger', 8, 5);
...
INSERT INTO item_attribute (item_id, critical, dmg_shadow) values ('we_inconspicuousdagger', 8, 3);
...
INSERT INTO item_attribute (item_id, dmg_ice, critical, dmg_shadow) values ('we_herbalistblade', 2, 7, 2);
...
INSERT INTO item_attribute (item_id, dmg_shadow, dmg_fire, dmg_physical, dmg_light, critical, dmg_ice) values ('we_doublesickle', 5, 5, 10, 5, 5, 5);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_light, critical, dmg_fire) values ('we_doublesickle_fire', 10, 15, 8, 15);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_ice, critical, dmg_shadow) values ('we_doublesickle_dark', 10, 15, 8, 15);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_ice, haste, critical) values ('we_jasonsglaive', 20, 5, 20, 3);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_light, critical, haste, dmg_fire) values ('we_jasonsglaive_fire', 20, 12, 4, 30, 12);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_ice, haste, dmg_shadow, critical) values ('we_jasonsglaive_dark', 20, 12, 30, 12, 4);
...
INSERT INTO item_attribute (item_id, dmg_physical, critical, haste, dmg_fire) values ('we_fireglaive', 10, 5, 10, 10);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_light, critical, haste, dmg_fire) values ('we_fireglaive_fire', 10, 15, 6, 20, 15);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_ice, haste, dmg_shadow, critical) values ('we_fireglaive_dark', 10, 15, 20, 15, 6);
...
INSERT INTO item_attribute (item_id, dmg_physical, critical, max_health) values ('we_pickaxe', 1, 1, 3);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_ice, haste, dmg_shadow, critical) values ('we_oathbreaker', 10, 10, 20, 10, 15);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_light, haste, max_health, dmg_fire) values ('we_pikeoflight', 5, 15, 10, 20, 15);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_ice, max_health, dmg_shadow) values ('we_bonescythe', 15, 5, 30, 15);
...
INSERT INTO item_attribute (item_id, dmg_light, critical, dmg_fire) values ('we_firesword', 8, 4, 12);
...
INSERT INTO item_attribute (item_id, dmg_physical, dmg_ice, haste, critical, dmg_fire) values ('we_janusglaive', 5, 8, 10, 3, 8);
