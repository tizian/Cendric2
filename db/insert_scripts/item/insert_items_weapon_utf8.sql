...
INSERT INTO item (item_id, item_type, icon_left, icon_top, gold_value, rarity) values ('we_icestaff', 'eq_weapon', 200, 150, 130, 2);
...
INSERT INTO item (item_id, item_type, icon_left, icon_top, gold_value, rarity) values ('we_firestaff', 'eq_weapon', 50, 150, 80, 2);
...
INSERT INTO item (item_id, item_type, icon_left, icon_top, gold_value, rarity) values ('we_tearstaff', 'eq_weapon', 550, 350, 75, 2);
...
INSERT INTO item (item_id, item_type, icon_left, icon_top, gold_value, rarity) values ('we_pearlsabre', 'eq_weapon', 350, 650, 150, 2);
...
INSERT INTO item (item_id, item_type, icon_left, icon_top, gold_value, rarity) values ('we_lightningpike', 'eq_weapon', 650, 0, 200, 3);
...
INSERT INTO item (item_id, item_type, icon_left, icon_top, gold_value, rarity) values ('we_sicklestaff', 'eq_weapon', 250, 150, 210, 3);
...
INSERT INTO item (item_id, item_type, icon_left, icon_top, gold_value, rarity) values ('we_pikeoflight', 'eq_weapon', 300, 250, 400, 3);
...
INSERT INTO item (item_id, item_type, icon_left, icon_top, gold_value, rarity) values ('we_bonescythe', 'eq_weapon', 700, 600, 400, 3);
...
INSERT INTO item (item_id, item_type, icon_left, icon_top, gold_value, rarity) values ('we_hawthorn', 'eq_weapon', 300, 100, 45, 1);
...
INSERT INTO item (item_id, item_type, icon_left, icon_top, gold_value, rarity) values ('we_zeffssword', 'eq_weapon', 350, 350, 120, 2);
...
INSERT INTO item (item_id, item_type, icon_left, icon_top, gold_value, rarity) values ('we_torch', 'eq_weapon', 200, 100, 40, 1);
...
INSERT INTO item_equipment_light(item_id, light_offset_x, light_offset_y, light_radius_x, light_radius_y, map_light_radius_x, map_light_radius_y, brightness) values ('we_celestialclaws', 0, -30, 150, 150, 80, 100, 0.3);
INSERT INTO item_equipment_particle (item_id, particle_count, emit_rate, additive_blend_mode, texture_path, spawner_radius, spawner_offset_x, spawner_offset_y, size_start_min, size_start_max, size_end_min, size_end_max, color_start_min_r, color_start_min_g, color_start_min_b, color_start_min_a, color_start_max_r, color_start_max_g, color_start_max_b, color_start_max_a, color_end_min_r, color_end_min_g, color_end_min_b, color_end_min_a, color_end_max_r, color_end_max_g, color_end_max_b, color_end_max_a, goal_radius, goal_offset_x, goal_offset_y, speed_min, speed_max, time_min, time_max, attract_fraction) values ('we_celestialclaws', 50, 15, 1, 'res/texture/particles/star.png', 30, 0, -30, 
8, 12, 0, 0,
100, 200, 255, 255,
100, 255, 255, 255,
255, 255, 255, 255,
