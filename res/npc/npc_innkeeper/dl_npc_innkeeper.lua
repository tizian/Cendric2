...
loadDialogue = function(DL)
		...
		if (not DL:isConditionFullfilled("npc_innkeeper", "asked_for_feudal_fire")) then 
			DL:addChoice(30, "DL_Choice_INeedSchnapps") --  I'm looking for a special schnapps... 
		end
		if (not DL:isConditionFullfilled("npc_innkeeper", "bought_feudal_fire") and DL:isConditionFullfilled("npc_innkeeper", "wrong_name")) then 
		...
		if (not DL:isConditionFullfilled("npc_innkeeper", "bought_feudal_fire") and DL:isConditionFullfilled("npc_innkeeper", "right_name")) then 
