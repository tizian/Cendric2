...
const float InventoryDescriptionWindow::DESCRIPTION_WINDOW_WIDTH = 340.f;
const float MARGIN = 20.f;
const int CHARACTER_SIZE = 8;

InventoryDescriptionWindow::InventoryDescriptionWindow(const Item& item) : Window(
	sf::FloatRect(0.f, 0.f, DESCRIPTION_WINDOW_WIDTH, DESCRIPTION_WINDOW_WIDTH),
	...
	CENDRIC_COLOR_LIGHT_PURPLE) // ornament
{
	...
	m_descriptionText.setString(g_textProvider->getCroppedText(item.getDescription(), CHARACTER_SIZE, static_cast<int>(DESCRIPTION_WINDOW_WIDTH - 2 * MARGIN)));
