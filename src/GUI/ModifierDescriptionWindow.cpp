...
ModifierDescriptionWindow::ModifierDescriptionWindow(const SpellModifier& modifier) : Window(sf::FloatRect(), WindowOrnamentStyle::NONE, sf::Color(0, 0, 0, 70), sf::Color(0, 0, 0, 70), sf::Color::White)
{
