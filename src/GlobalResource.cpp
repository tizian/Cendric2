...
const std::string GlobalResource::FONT_12 = "res/fonts/default_bitmap_font_12.png";
const std::string GlobalResource::FONT_12_SHADOWED = "res/fonts/shadowed_bitmap_font_12.png";
...
const std::string GlobalResource::TEX_GUI_SPELL_COLOR_ELEMENTAL = "res/assets/gui/spell_color_elemental.png";
const std::string GlobalResource::TEX_GUI_SPELL_COLOR_TWILIGHT = "res/assets/gui/spell_color_twilight.png";
const std::string GlobalResource::TEX_GUI_SPELL_COLOR_NECROMANCY = "res/assets/gui/spell_color_necromancy.png";
const std::string GlobalResource::TEX_GUI_SPELL_COLOR_DIVINE = "res/assets/gui/spell_color_divine.png";
const std::string GlobalResource::TEX_GUI_SPELL_COLOR_ILLUSION = "res/assets/gui/spell_color_illusion.png";
