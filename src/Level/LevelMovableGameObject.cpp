...
void LevelMovableGameObject::setFightAnimation(GameObjectState fightAnimation, bool isBlocking) {
	m_movingBehavior->setFightAnimation(fightAnimation, isBlocking);
}
